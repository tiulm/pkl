                            ...
                            <div class="col-12 col-sm-4">
                                <div class="info-box bg-success">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number text-center mb-0">{{ $anggota->GroupProjectSchedule->day }}, {{Auth::user()->convertTanggal($anggota->GroupProjectSchedule->tanggal)}}</span>
                                    </div>
                                </div>
                            </div>
                            @else
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <p class="text-sm">Tanggal & Waktu
                                                <b class="d-block">{{ $anggota->GroupProjectSchedule->day }}, {{Auth::user()->convertTanggal($anggota->GroupProjectSchedule->tanggal)}}</b>
