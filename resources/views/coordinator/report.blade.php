                ...
                <table id="report" class="table table-striped projects dataTable w-100">
                    <thead>
                        <tr>
                            ...
                            <th>Kelompok</th>
                            <th width="200px">Catatan Revisi & Laporan</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            },
            {
                ...
                "render": function(data, type, full, meta) {
                    if((full.report === null) && (full.laporan === null)){
                        ...
                        return '<span class="badge badge-danger p-2 m-1">Catatan Revisi Belum Tersedia</span><span class="badge badge-danger p-2 m-1">Laporan Sudah Dikumpul</span>'
                    } else if ((full.report !== null) && (full.laporan !== null)) {
